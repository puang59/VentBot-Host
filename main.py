        ...
        if not msg.author.id == 943928873412870154:
            if msg.channel.id != 943556439195152477:
                if not isinstance(msg.channel, discord.channel.DMChannel):
                    if not msg.channel.category.id == 950646823654137897 or msg.channel.category.id == 987983272069976114 or msg.channel.category.id == 987986457069240401 or msg.channel.category.id == 943588904622256168:
            ...
            if collection.find_one({"msg_id": payload.message_id}):
                ...
                if msg_owner is None: 
                    ...
                    try: 
                        ...
                        text_channel_replier = await categOwner.create_text_channel(f"{inboxCode}{payload.member.discriminator}")
                        ...
                        text_channel_owner = await categOwner.create_text_channel(f"{inboxCode}{payload.member.discriminator}")
